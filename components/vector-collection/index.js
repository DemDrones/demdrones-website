...
export function Vector(props) {
  ...
  return (
    <svg {...otherProps} className={`icon ${className}`} width={width} height={height} style={style}>
      <use xlinkHref={`#${id}`} />
    </svg>
  );
}
    ...
    <div hidden>
      <svg xmlns="http://www.w3.org/2000/svg" aria-hidden={true} focusable={false}>
        <symbol id={VECTOR.ICON_ARROW} viewBox="0 0 24 24">
          <path fill="currentColor" d="M12.5 0l-2.2 2 8 8.4H0v3.1h18.4L10.3 22l2.2 2L24 12 12.5 0z" />
        </symbol>
